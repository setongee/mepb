        ...
        <Container>
            ...
            <div className="socials__time flex">
                ...
                <div className="account flex gap__30">
                    <a target='_Blank' href={data?.socials?.instagram}><Instagram/></a>
                    <a target='_Blank' href={data?.socials?.x}><X/></a>
                    <a target='_Blank' href={data?.socials?.youtube}><Youtube/></a>
                    <a target='_Blank' href={data?.socials?.facebook}><Facebook/></a>
                </div>
            </div>
